...
const Checkout = () => {
    ...
    const handlePlaceOrder = event => {
        ...
        fetch('https://genius-car-server-omega-red.vercel.app/orders', {
            method: 'POST',
            headers: {
    ...
    return (
        <div>
            <form onSubmit={handlePlaceOrder}>
                ...
                <textarea name='message' className="textarea textarea-bordered w-full h-24" placeholder="Your Message" required></textarea>
